...
interface VaultTrusteesViewProps {
  onBack: () => void;
}

export default function VaultTrusteesView({ onBack }: VaultTrusteesViewProps) {
  ...
  return (
    <div className="max-w-2xl">
      <button onClick={onBack} className="inline-block text-sm text-navy hover:text-gold transition-colors mb-4">&larr; Back to Vault</button>
