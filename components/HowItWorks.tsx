const steps = [
  {
    ...
    description:
      "Our smart quiz learns about your family in plain English. No legal jargon required.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Attorney-reviewed templates create your personalized estate plan instantly.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Your documents and your family\u2019s vault, all in one secure place forever.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    <section id="how-it-works" className="bg-white py-24 px-6">
      <div className="mx-auto max-w-5xl text-center">
        <div className="inline-flex items-center gap-2 rounded-full bg-navy-50 px-4 py-1.5 mb-4">
          <span className="text-xs font-semibold text-navy tracking-wide uppercase">Simple Process</span>
        </div>
        ...
        <p className="mt-4 text-lg text-charcoal/50 max-w-xl mx-auto">
          Three simple steps to protect your family&apos;s future.
        </p>
