  ...
  return (
    <section id="vault" className="relative hero-gradient py-24 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-64 h-64 rounded-full bg-gold/5 blur-3xl animate-float" />
        <div className="absolute -bottom-10 left-20 w-48 h-48 rounded-full bg-gold/5 blur-3xl animate-float-delayed" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-4">
          {categories.map((cat) => (
            <div
              key={cat.label}
              className="group glass rounded-2xl p-6 text-center hover:border-gold/30 hover:bg-white/12 transition-all duration-300 hover:-translate-y-0.5"
            >
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gold/10 text-gold mb-4 group-hover:scale-110 transition-transform duration-300">
                {cat.icon}
              </div>
