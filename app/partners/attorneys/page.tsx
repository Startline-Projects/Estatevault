...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "If a client's intake indicates a special-needs dependent, Medicaid planning, or an active estate dispute, the platform halts document generation and flags the case directly to you for a full engagement. These are your clients, not referrals.",
  },
  {
...
export default function AttorneyPartnerPage() {
  ...
  const trustSplit = calcTier === 'standard' ? 400 : 450;
        ...
        <div className={styles.container}>
          ...
          <div className={styles.howGrid}>
            ...
            {[
              ...
              { n: 4, t: 'Complex cases become engagements', d: 'Special-needs dependents, Medicaid planning, estate disputes, flagged to you.' },
            ].map((s, i) => (
      ...
      <section className={`${styles.section} ${styles.upsellWrap}`}>
        <div className={styles.containerSm}>
          <div className={`${styles.sectionHead} ${styles.reveal}`} ref={registerReveal(17)}>
            ...
            <p>
              When a client&apos;s situation involves a special-needs dependent, Medicaid
              planning, or an active estate dispute, the platform flags the case and routes it
              directly to you.
            </p>
          </div>
