  ...
  if (!partner) {
    return (
      <div className="py-16 text-center">
        ...
        <Link href="/sales/partners" className="text-[#C9A84C] text-sm mt-2 inline-block">Back to partners</Link>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <nav className="flex items-center gap-2 text-sm text-gray-400 mb-4">
        <Link href="/sales/partners" className="hover:text-[#C9A84C] transition">Partners</Link>
        <span>/</span>
