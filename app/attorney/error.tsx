...
export default function AttorneyError({ error, reset }: ErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
      ...
      <p className="text-sm text-charcoal/60 mb-6 max-w-sm">Please try again or return to the attorney portal.</p>
      ...
      <div className="flex gap-3">
        ...
        <Link href="/attorney" className="rounded-full border border-gray-300 px-5 py-2.5 text-sm font-semibold text-navy hover:bg-gray-50 transition-colors">Back to Portal</Link>
      </div>
    </div>
  );
}
