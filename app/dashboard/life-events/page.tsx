...
const EVENTS = [
  ...
  { id: "business", icon: "💼", title: "Started or Sold a Business", description: "Business ownership significantly affects your estate plan.", urgent: false, recommendation: "Business interests require careful estate planning. Attorney review is available for this change.", action: "attorney" },
  { id: "death", icon: "🕊", title: "Loss of a Beneficiary or Trustee", description: "Your plan references someone who has passed. An update is needed.", urgent: true, recommendation: "Your estate plan names someone who is no longer living. Successor provisions may apply, but an update may be needed.", action: "amendment" },
  ...
  { id: "assets", icon: "💰", title: "Significant Change in Assets", description: "Major asset changes, inheritance, large purchase, retirement account changes, may affect your plan.", urgent: false, recommendation: "Significant changes in net worth may affect your estate planning approach.", action: "amendment" },
];
