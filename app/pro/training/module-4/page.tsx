...
const MODULE_ID = 4;
const MODULE_TITLE = "Sales & Client Conversations";
const MODULE_DESCRIPTION =
  "Learn how to introduce estate planning to your clients naturally, handle common objections, and guide prospects through the decision-making process. This module includes conversation frameworks and real-world examples.";
