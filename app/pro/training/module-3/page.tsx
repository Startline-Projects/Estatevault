...
const MODULE_ID = 3;
const MODULE_TITLE = "Compliance & Legal Boundaries";
const MODULE_DESCRIPTION =
  "This is the most important module. You will learn what you can and cannot say to clients, how hard stop conditions work, when cases are routed to attorneys, and how to stay compliant with state and federal regulations.";
      ...
      <div className="rounded-xl bg-white border border-gray-200 p-8">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => router.push("/pro/training/module-4")}
