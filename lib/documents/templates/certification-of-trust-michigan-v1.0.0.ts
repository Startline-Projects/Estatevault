...
This Certification of Trust is made under Mich. Comp. Laws § 700.7913 and is signed by each Trustee presently serving under the {{trust_name_bare}} dated {{trust_date}}. The undersigned {{#IF is_joint_trust equals true}}Trustees certify{{/IF}}{{#IF is_joint_trust equals false}}Trustee certifies{{/IF}} the following:
...
{{client_full_name}} and {{grantor_2_full_name}}, Trustees of the {{trust_name_bare}} dated {{trust_date}}, and any amendments to it

{{/IF}}

{{#IF is_joint_trust equals false}}

{{client_full_name}}, Trustee of the {{trust_name_bare}} dated {{trust_date}}, and any amendments to it

{{/IF}}

OR

The {{trust_name_bare}} dated {{trust_date}}
