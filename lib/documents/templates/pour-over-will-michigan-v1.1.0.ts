// GENERATED FILE — do not edit. Source: pour-over-will-michigan-v1.1.0.txt
...
Companion Trust: {{trust_name_display}}
...
### Section [[SECTION:final_wishes.s1]] — Funeral and Burial Preference.
...
IN WITNESS WHEREOF, I, {{client_full_name}}, the Testator, sign my name to this Pour-Over Will on this _ day of _, 20_, and being duly identified by the witnesses below, declare to them that this is my Last Will and Testament, that I sign it willingly, that I execute it as my free and voluntary act, and that I am of legal age (eighteen years or older) and of sound mind, and under no constraint or undue influence.
...
{{!--
Section E is Mo Murshed's seven steps for the Last Will, approved 2026-09-13 and
approved for this document by email on 2026-09-14. Step 5 is the correction he
approved in the same round; this document carries a self-proving affidavit under
its own heading, so the step is accurate here.

Two points his steps did not carry are restored on his instruction, in his
sentences: Step 3 bars beneficiaries of the companion Trust as well as this
Will, and Steps 6 and 7 keep the original with the Trust and tell the Personal
Representative where both documents are.
--}}
...
Immediately after you sign, both witnesses must sign their names and provide their full addresses on the signature page. Witnesses should not be beneficiaries under this Will or the companion Trust.
...
Store your original signed Will together with your {{trust_name_bare}} in a safe place, such as a safe deposit box, fireproof safe, or with your Personal Representative. Do not store it where it might be damaged, lost, or mistaken for a draft. You may also upload a copy to your EstateVault account for safekeeping.

STEP 7 - Inform Your Personal Representative

Inform your Personal Representative (the person you named to carry out your Will) where this original Will and the Trust are stored and provide them with a copy. Give them any password or access information they may need to locate it.
