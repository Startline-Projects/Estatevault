...
### Section 3.2 — Restoration of Capacity.
...
### Section 4.3 — Limitations on Agent's Authority.

The Agent shall NOT make or amend a will on my behalf; vote in any public election on my behalf; execute, modify, or revoke an Advance Healthcare Directive on my behalf (medical decisions are governed by a separate Advance Healthcare Directive); take any action that would be in violation of Michigan or federal law; or take any action that would be a breach of the Agent's fiduciary duties under MCL 556.214.

### Section 4.4 — Incorporation of Statutory Authority.
...
This is your Durable Power of Attorney under the Michigan Uniform Power of Attorney Act, effective July 1, 2024. It authorizes the person you name (your Agent) to handle your financial matters. "Durable" means it remains effective if you later become unable to manage your own affairs. It does NOT authorize medical decisions, which are governed by your Advance Healthcare Directive. This document terminates automatically upon your passing.
...
Your Agent does not have authority to act unless you have been deemed incapacitated. Until that point your Agent may not touch your accounts, sign for you, or act for you in any way.

If you later recover, your Agent's authority is suspended again for as long as you are able to manage your own affairs.

{{/IF}}

### Section B — Making This Document Effective

Sign and date this document in front of two witnesses and a notary public, and have the notary complete the notary section.
...
State of Michigan · Michigan Uniform Power of Attorney Act
