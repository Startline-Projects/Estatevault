...
### Section [[SECTION:distribution.s2]] — Remainder Beneficiaries.

{{#IF contingent_beneficiaries_not_empty}}

If all of the primary beneficiaries named in Section [[REF:distribution.s1]] fail to survive me by thirty (30) days, I direct the Trustee to distribute the Trust estate to the following remainder beneficiaries in the shares indicated:
...
### Section [[SECTION:distribution.s3]] — Final Disposition.

If all of the primary beneficiaries named in Section [[REF:distribution.s1]], and all of the remainder beneficiaries named in Section [[REF:distribution.s2]] (if any), fail to survive me by thirty (30) days, the Trust estate shall be distributed to my heirs at law, as determined under the laws of the State of Michigan governing intestate succession, in effect at the time of my passing.
